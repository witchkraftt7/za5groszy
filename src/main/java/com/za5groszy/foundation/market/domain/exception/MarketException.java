...
public class MarketException extends DomainModelException {
    static final int INSUFFICIENT_AMOUNT_OF_BIDS_ERROR_CODE = 10;
    static final int ITEM_AUCTION_FINISHED_ERROR_CODE = 11;

    private ItemId itemId;
    private UserId userId;

    MarketException(String message, UserId userId, ItemId itemId, int errorCode) {
